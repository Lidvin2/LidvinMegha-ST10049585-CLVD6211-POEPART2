...
namespace CLVD6211_POEPART2.Models
{
    public class ProductDisplayModel
    {
        ...
        public static List<ProductDisplayModel> SelectProducts()
        {
            ...
            string con_string = "Server=tcp:clvd-sql-khumalocraft.database.windows.net,1433;Initial Catalog=Clvd-db;Persist Security Info=False;User ID=KHUMALOCRAFT;Password=Dead@2424;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
